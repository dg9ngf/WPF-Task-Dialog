...
namespace Unclassified.WpfTaskDialog
{
	public partial class TaskDialog
	{
		...
		/// </summary>
		/// <param name="e">The <see cref="Unclassified.WpfTaskDialog.TaskDialogShowingEventArgs"/> instance containing the event data.</param>
		...
		/// </summary>
		/// <param name="e">The <see cref="Unclassified.WpfTaskDialog.TaskDialogClosedEventArgs"/> instance containing the event data.</param>
